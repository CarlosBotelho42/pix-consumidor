...
public class PixRecord extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private CharSequence identificador;
  private CharSequence chaveOrigem;
  private CharSequence chaveDestino;
  private double valor;
  private CharSequence dataTransferencia;
   ...
   */
  public PixRecord(CharSequence identificador, CharSequence chaveOrigem, CharSequence chaveDestino, Double valor, CharSequence dataTransferencia, CharSequence status) {
  ...
  public void put(int field$, Object value$) {
    switch (field$) {
    case 0: identificador = (CharSequence)value$; break;
    case 1: chaveOrigem = (CharSequence)value$; break;
    case 2: chaveDestino = (CharSequence)value$; break;
    case 3: valor = (Double)value$; break;
    case 4: dataTransferencia = (CharSequence)value$; break;
   ...
   */
  public CharSequence getIdentificador() {
   ...
   */
  public void setIdentificador(CharSequence value) {
   ...
   */
  public CharSequence getChaveOrigem() {
    return chaveOrigem;
  }
   ...
   * @param value the value to set.
   */
  public void setChaveOrigem(CharSequence value) {
   ...
   */
  public CharSequence getChaveDestino() {
    return chaveDestino;
  }
   ...
   * @param value the value to set.
   */
  public void setChaveDestino(CharSequence value) {
   ...
   */
  public CharSequence getDataTransferencia() {
   ...
   * @param value the value to set.
   */
  public void setDataTransferencia(CharSequence value) {
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PixRecord>
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setIdentificador(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setChaveOrigem(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setChaveDestino(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setDataTransferencia(CharSequence value) {
    ...
    public PixRecord build() {
      try {
        ...
        record.identificador = fieldSetFlags()[0] ? this.identificador : (CharSequence) defaultValue(fields()[0]);
        record.chaveOrigem = fieldSetFlags()[1] ? this.chaveOrigem : (CharSequence) defaultValue(fields()[1]);
        record.chaveDestino = fieldSetFlags()[2] ? this.chaveDestino : (CharSequence) defaultValue(fields()[2]);
        record.valor = fieldSetFlags()[3] ? this.valor : (Double) defaultValue(fields()[3]);
        record.dataTransferencia = fieldSetFlags()[4] ? this.dataTransferencia : (CharSequence) defaultValue(fields()[4]);
